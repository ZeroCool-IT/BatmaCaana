...
public class LayoutRipple extends CustomView {
	...
	Integer materialLibraryRippleColor;
	Float xRippleOrigin;
	Float yRippleOrigin;
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		int rippleColor = attrs.getAttributeResourceValue(MATERIALDESIGNXML,
				"materialLibraryRippleColor", -1);
		if (rippleColor != -1) {
			setMaterialLibraryRippleColor(getResources().getColor(rippleColor));
		} else {
			// Color by hexadecimal
			int background = attrs.getAttributeIntValue(MATERIALDESIGNXML, "materialLibraryRippleColor", -1);
			if (background != -1)
				setMaterialLibraryRippleColor(background);
			else
				setMaterialLibraryRippleColor(makePressColor());
		}
	...
	public Bitmap makeCircle() {
		...
		if (materialLibraryRippleColor == null)
			materialLibraryRippleColor = makePressColor();
		paint.setColor(materialLibraryRippleColor);
	...
	public void setMaterialLibraryRippleColor(int materialLibraryRippleColor) {
		this.materialLibraryRippleColor = materialLibraryRippleColor;
	}
